...
/*class BagBunkergreenSmall: Exile_AbstractCraftingRecipe//V0.2.6
{
	name = "BagBunker Green Small APEX";
	pictureItem = "Land_BagBunker_01_small_green_F_Kit";
	returnedItems[] = 
	{
		{1, "Exile_Item_WaterCanisterEmpty"},
		{1, "Exile_Item_FuelCanisterEmpty"},
		{1, "Land_BagBunker_01_small_green_F_Kit"}
	};
	requiresFire = 0;
...
/*class BagBunkertowerGreen: Exile_AbstractCraftingRecipe//V0.2.6
{
	name = "BagBunker Green Tower APEX";
	pictureItem = "Land_HBarrier_01_tower_green_F_Kit";
	returnedItems[] = 
	{
		{1, "Land_HBarrier_01_tower_green_F_Kit"}
	};
	requiresFire = 1;
	requiredInteractionModelGroup = "WorkBench";
	components[] = 
