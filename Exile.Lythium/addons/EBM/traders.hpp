...
class EBMWalls
	{
		...
		items[] = 
		{
			...
			//"Land_PetroglyphWall_02_F_Kit",
			//"Land_PetroglyphWall_01_F_Kit",
			//"Land_Breakwater_02_F_Kit",
			//"Land_Breakwater_01_F_Kit",
			//"Land_BasaltWall_01_gate_F_Kit",
			//"Land_BasaltWall_01_8m_F_Kit",
			//"Land_BasaltWall_01_4m_F_Kit",
			...
			//not recommended to turn them on, but if you want to, uncomment them
