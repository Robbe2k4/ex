...
ExileClientSafeZoneESPEventHandler = addMissionEventHandler ["Draw3D", {50 call ExileClient_gui_safezone_safeESP}];
["Welcome! You entered a safe zone."] spawn ExileClient_gui_baguette_show;
