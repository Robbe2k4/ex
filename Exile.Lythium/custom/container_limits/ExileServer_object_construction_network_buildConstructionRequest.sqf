...
try
{
	...
	switch (_canBuildHereResult) do
	{
		...
		case 103:
		{
		throw "Maximum number of Ammobox Pallet Kits reached.";
		};
		case 104:
		{
		throw "Maximum number of Small Containers reached.";
		};
		case 105:
		{
		throw "Maximum number of Land Container Sand reached.";
		};
		case 106:
		{
		throw "Maximum number of Land Container Green reached.";
		};
		case 107:
		{
		throw "Maximum number of Huge Containers reached.";
		};
	};
