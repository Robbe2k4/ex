...
else 
{
	...
	["ErrorTitleAndText", ["Whoops!", "LOL! Did you actually think we were just giving these away for free? Kudos for trying though."]] call ExileClient_gui_toaster_addTemplateToast;
};