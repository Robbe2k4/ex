...
_nearVehicles = nearestObjects [player, ["LandVehicle", "Air", "Ship", "Exile_Container_SupplyBox", "I_CargoNet_01_ammo_F", "O_CargoNet_01_ammo_F", "B_CargoNet_01_ammo_F", "Box_NATO_Wps_F", "Box_NATO_Ammo_F", "CargoNet_01_box_F"], 80];
{
	if (local _x) then
	{
		if (alive _x) then
