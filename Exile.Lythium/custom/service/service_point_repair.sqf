...
private ["_vehicle","_args","_servicePoint","_costs","_repairTime","_type","_name","_hitpoints","_allRepaired","_exilew","_veh"];
...
if (_exilew < _costs) exitWith {['ErrorTitleAndText',[format['You need %1 Pop-Tabs to repair your %2', _costs,_name]]] call ExileClient_gui_toaster_addTemplateToast;};
