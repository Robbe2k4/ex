...
// Intro Messages
///////////////////////////////////////////////////////////////////////////
[] execVM "addons\ToastMsgs\IntroToasts.sqf";

if (!hasInterface || isServer) exitWith {};

///////////////////////////////////////////////////////////////////////////
// Friendly Tags For PVE
///////////////////////////////////////////////////////////////////////////
[1600 // maximum distance to show name
,false // show distance to player? (false = dont show)
] execVM "addons\playerNames.sqf";

///////////////////////////////////////////////////////////////////////////
// Recover Body From Wrecked Vehicle
///////////////////////////////////////////////////////////////////////////
NR_fnc_RecoverBody = compileFinal preprocessFileLineNumbers "addons\RecoverBody\RecoverBody.sqf";
...
["Exile_Trader_Vehicle", ["HubStandingUA_idle1","HubStandingUA_idle2","HubStandingUA_idle3","HubStandingUA_move1","HubStandingUA_move2"], "Exile_Trader_Vehicle", "AfricanHead_02", [[],[],[],["U_I_G_Story_Protagonist_F",[]],[],[],"H_Bandanna_gry","G_Lady_Blue",[],["","","","","",""]], [10726, 3334.78, 23.0867], [-0.877514, -0.47955, 0], [0, 0, 1]],
["Exile_Trader_VehicleCustoms", ["HubStandingUA_idle1","HubStandingUA_idle2","HubStandingUA_idle3","HubStandingUA_move1","HubStandingUA_move2"], "Exile_Trader_VehicleCustoms", "WhiteHead_15", [[],[],[],["U_C_WorkerCoveralls",[]],[],[],"","",[],["","","","","",""]], [10733, 3325.9, 23.0954], [0.782932, 0.622107, 0], [0, 0, 1]],
["Exile_Trader_Aircraft", ["HubStandingUA_idle1","HubStandingUA_idle2","HubStandingUA_idle3","HubStandingUA_move1","HubStandingUA_move2"], "Exile_Trader_Aircraft", "WhiteHead_08", [[],[],[],["U_I_pilotCoveralls",[]],["V_Rangemaster_belt",[]],[],"H_Beret_blk","G_Aviator",[],["","","","","",""]], [10723.7, 3337.68, 23.087], [-0.609308, -0.792933, 0], [0, 0, 1]],
["Exile_Trader_AircraftCustoms", ["HubStandingUA_idle1","HubStandingUA_idle2","HubStandingUA_idle3","HubStandingUA_move1","HubStandingUA_move2"], "Exile_Trader_AircraftCustoms", "WhiteHead_07", [[],[],[],["U_C_WorkerCoveralls",[]],[],[],"H_Cap_usblack","",[],["","","","","",""]], [10720, 3347.88, 23.0842], [-0.852009, -0.523527, 0], [0, 0, 1]],
["Exile_Trader_Armory", ["HubStandingUA_idle1","HubStandingUA_idle2","HubStandingUA_idle3","HubStandingUA_move1","HubStandingUA_move2"], "Exile_Trader_Armory", "WhiteHead_14", [["Exile_Weapon_SVD","","","optic_AMS",["Exile_Magazine_10Rnd_762x54",10],[],""],[],["hgun_Pistol_01_F","","","",["10Rnd_9x21_Mag",10],[],""],["U_I_C_Soldier_Para_2_F",[["Exile_Magazine_10Rnd_762x54",3,10],["10Rnd_9x21_Mag",3,10]]],["V_BandollierB_cbr",[]],[],"H_ShemagOpen_tan","G_Combat",[],["","","","","",""]], [10763.9, 3344.55, 26.1766], [0.125788, -0.992057, 0], [0, 0, 1]],
["Exile_Trader_Equipment", ["HubStandingUA_idle1","HubStandingUA_idle2","HubStandingUA_idle3","HubStandingUA_move1","HubStandingUA_move2"], "Exile_Trader_Equipment", "WhiteHead_17", [["Exile_Weapon_AKM","","","optic_Aco",["Exile_Magazine_30Rnd_762x39_AK",30],[],""],[],["hgun_Pistol_01_F","","","",["10Rnd_9x21_Mag",10],[],""],["U_I_C_Soldier_Bandit_3_F",[["10Rnd_9x21_Mag",3,10]]],["V_I_G_resistanceLeader_F",[["Exile_Magazine_30Rnd_762x39_AK",3,30]]],[],"H_Cap_tan","",[],["","","","","",""]], [10766.1, 3336.34, 26.4139], [-0.079171, 0.996861, 0], [0, 0, 1]],
["Exile_Trader_Food", ["HubStandingUA_idle1","HubStandingUA_idle2","HubStandingUA_idle3","HubStandingUA_move1","HubStandingUA_move2"], "Exile_Trader_Food", "WhiteHead_02", [[],[],[],["U_C_Journalist",[]],[],[],"","",[],["","","","","",""]], [10766.5, 3340.23, 23.322], [-0.5547, -0.83205, 0], [0, 0, 1]],
["Exile_Trader_Hardware", ["HubStandingUA_idle1","HubStandingUA_idle2","HubStandingUA_idle3","HubStandingUA_move1","HubStandingUA_move2"], "Exile_Trader_Hardware", "WhiteHead_15", [[],[],[],["U_I_C_Soldier_Bandit_4_F",[]],[],[],"H_Hat_tan","",[],["","","","","",""]], [10764.1, 3344.07, 23.3497], [-0.991077, 0.133294, 0], [0, 0, 1]],
["Exile_Trader_Office", ["HubStandingUA_idle1","HubStandingUA_idle2","HubStandingUA_idle3","HubStandingUA_move1","HubStandingUA_move2"], "Exile_Trader_Office", "GreekHead_A3_06", [[],[],[],["U_B_GEN_Commander_F",[]],["V_BandollierB_blk",[]],[],"H_Cap_police","",[],["","","","","",""]], [10772.5, 3332.04, 23.6448], [-0.32104, -0.947066, 0], [0, 0, 1]],
...
// Black Market Trader Units
// 2 NPCs
//Mafaraz
["Exile_Trader_CommunityCustoms4", ["HubStanding_idle1","HubStanding_idle2","HubStanding_idle3"], "Exile_Trader_CommunityCustoms4", "GreekHead_A3_06", [["Exile_Weapon_AK74","","","",["Exile_Magazine_30Rnd_545x39_AK",30],[],""],[],["hgun_Pistol_heavy_01_F","","","",["11Rnd_45ACP_Mag",11],[],""],["U_C_HunterBody_grn",[["Exile_Magazine_30Rnd_545x39_AK",1,30]]],["V_Rangemaster_belt",[["11Rnd_45ACP_Mag",3,11],["Exile_Magazine_30Rnd_545x39_AK",1,30]]],[],"H_Cap_tan","",[],["","","","","",""]], [5640.59, 9818.17, 266.557], [0.958438, -0.285302, 0], [0, 0, 1]],
// Zarath
["Exile_Trader_CommunityCustoms4", ["HubStanding_idle1","HubStanding_idle2","HubStanding_idle3"], "Exile_Trader_CommunityCustoms4", "GreekHead_A3_06", [["Exile_Weapon_AK74","","","",["Exile_Magazine_30Rnd_545x39_AK",30],[],""],[],["hgun_Pistol_heavy_01_F","","","",["11Rnd_45ACP_Mag",11],[],""],["U_C_HunterBody_grn",[["Exile_Magazine_30Rnd_545x39_AK",1,30]]],["V_Rangemaster_belt",[["11Rnd_45ACP_Mag",3,11],["Exile_Magazine_30Rnd_545x39_AK",1,30]]],[],"H_Cap_tan","",[],["","","","","",""]], [17513.2, 14667.4, 72.7447], [0.790989, -0.611831, 0], [0, 0, 1]],

// 2 NPCs
// COG Fun Zone
["Exile_Trader_CommunityCustoms3", ["HubStandingUA_idle1","HubStandingUA_idle2","HubStandingUA_idle3"], "Exile_Trader_CommunityCustoms3", "GreekHead_A3_06", [[],[],[],["Exile_Uniform_ExileCustoms",[]],[],[],"H_Cap_blk","G_Spectacles",[],["","","","","",""]], [16751.5, 20199.9, 217.968], [0.156434, -0.987688, 0], [0, 0, 1]],
["Exile_Trader_CommunityCustoms3", ["HubStandingUA_idle1","HubStandingUA_idle2","HubStandingUA_idle3"], "Exile_Trader_CommunityCustoms3", "GreekHead_A3_06", [[],[],[],["Exile_Uniform_ExileCustoms",[]],[],[],"H_Cap_blk","G_Spectacles",[],["","","","","",""]], [16798.3, 20118.5, 208.618], [-0.422618, -0.906308, 0], [0, 0, 1]]

// 1 NPCs
// COG Car Sales
// ["Exile_Trader_CommunityCustoms2", ["HubStandingUA_idle1","HubStandingUA_idle2","HubStandingUA_idle3"], "Exile_Trader_CommunityCustoms2", "GreekHead_A3_06", [[],[],[],["Exile_Uniform_ExileCustoms",[]],[],[],"H_Cap_blk","G_Spectacles",[],["","","","","",""]], [8767.39, 12162.5, 154.454], [0.784489, -0.620143, 0], [0, 0, 1]]
